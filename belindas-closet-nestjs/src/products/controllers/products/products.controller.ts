...
import { sanitizeProductForLogging } from '../../../utils/logging-sanitizer';
...
export class ProductsController {
  ...
  async createProduct(@Body() productDto: CreateProductDto, @GetUser() user: User) {
    this.logger.log(`Creating Product ${JSON.stringify(sanitizeProductForLogging(productDto), null, '\t')}`, this.CONTROLLER);
